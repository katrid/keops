...
from katrid.db import models, DEFAULT_DB_ALIAS
from katrid.utils.encoding import smart_text, is_protected_type
...
def Deserializer(object_list, **options):
    """
    Deserialize simple Python objects back into Katrid ORM instances.
    ...
    for d in object_list:
        ...
        if 'data-id' in d:
            _id = d.pop('data-id')
            from base.models import ModelData
            try:
