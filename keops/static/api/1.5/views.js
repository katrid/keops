...
(function() {
  var FacetView, SearchField, SearchFilter, SearchItem, SearchMenu, SearchQuery, SearchView,
  ...
  FacetView = (function() {
    ...
    FacetView.prototype.template = function() {
      ...
      s = '';
      if (this.item.ref) {
        s = "<span class=\"facet-label\">" + this.item.label + "</span>";
      }
  ...
  SearchItem = (function() {
    function SearchItem(name1, item1, parent1, ref, menu1) {
      this.name = name1;
      this.item = item1;
      this.parent = parent1;
      this.ref = ref;
      this.menu = menu1;
      if (this.ref.type === 'ForeignKey') {
        this.expandable = true;
        this.children = [];
      } else {
        this.expandable = false;
      }
      this.label = this.item.attr('caption') || (this.ref && this.ref['caption']) || this.name;
    }
  ...
  SearchField = (function(superClass) {
    ...
    function SearchField() {
      return SearchField.__super__.constructor.apply(this, arguments);
    }
  ...
  SearchView = (function() {
    ...
    SearchView.prototype.link = function(scope, el, attrs, controller, $compile) {
      var html, item, j, len, ref, searchView;
      html = $compile(this.template())(scope);
      el.replaceWith(html);
      html.addClass(attrs["class"]);
      this.$compile = $compile;
      this.view = scope.views.search;
      searchView = $(this.view.content);
      this.element = html;
    ...
    SearchView.prototype.loadItem = function(item, value, parent) {
      var cls, name, tag;
    ...
    SearchView.prototype.renderFacets = function() {
      var el, f, item, j, len, ref, results;
      ref = this.query.items;
      results = [];
      for (j = 0, len = ref.length; j < len; j++) {
        item = ref[j];
        if (!item.facet) {
